...
console.log('task one:', artists[2].bio)
...
console.log('task 4:', get20s(artists, '100'));
...
function addArtist(array) {
  artists.push({id: 20, name: 'Hannah Brog', years: '2003-2021', genre: 'Web Design', nationality: 'American', bio: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras feugiat lacinia odio, nec mollis nisi rhoncus vel.'})
  return array;
}

addArtist('task 6:', artists)
...
function lotsOfArt(array, names) {
 const returnArray = [];
 for(let i = 0; i < array.length; i++){
  if(array[i].names === true && array[i].paintings > 100){
    return names;
    }
  }
  return returnArray
